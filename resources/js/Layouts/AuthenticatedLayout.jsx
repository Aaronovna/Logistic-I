        ...
        <div className="flex h-screen">
            ...
            <aside className='bg-[#F3F8FF] w-80 hidden md:block'>
                ...
                <div className="flex flex-col">
                    ...
                    <a className='flex relative mt-2 mb-2 mr-4' href={route('test')}>
                        <span className={'w-4 rounded-xl absolute -left-2 h-full ' + (route().current('test')
                            ? 'bg-[#004369] rounded-xl text-white '
                            : 'text-[#004369] ')}>
                        </span>
                        <p className={
                            ' ml-10 flex p-2 w-full rounded-xl font-semibold text-[#004369] ' +
                            (route().current('test') ? 'bg-[#004369] text-white' : 'bg-[#E7F6FF]')}
                        >
                            <TbBuildingWarehouse className='mr-1' />
                            Management
                        </p>
                    </a>
